...
const covers = [
  { img: coverOne, path: "/allIssues" },
  { img: coverTwo, path: "/allIssues" },
  { img: coverThree, path: "/allIssues" },
  { img: coverFour, path: "/allIssues" },
  { img: coverFive, path: "/allIssues" },
  { img: coverSix, path: "/allIssues" },
];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-0 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0  md:gap-4 p-3 md:p-8">
          ...
          <div className="md:col-span-2 space-y-6 pr-4 relative">
            ...
            {articles.map((article, index) => (
              <div key={index} className="border-b border-gray-300 pb-4 p-3">
                <Link to={"/"}>
                  <h3 className="text-white text-sm inline-block px-3 py-2 bg-[#D2973B] hover:bg-yellow-700">
                    {article.date}
                  </h3>
                </Link>
