          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="mt-6   text-3xl font-bold border-b-2 pb-3 border-gray-300">
                <div>
                  <span className="">একটি ভিত্তিহীন দুআ ॥</span>
                </div>
                <span>খাওয়ার শুরুতে লবণ মুখে দেওয়ার দুআ</span>

                <div> </div>
              </p>

              <p className="pt-4">
                <p className=" text-center text-xl text-[#E98121] font-bold ">
                  আল্লাহুম্মা হানীয়াম মারীয়া
                </p>
                <br />

                <p className=" text-center text-xl ">
                  اَللّٰهُمَّ هَنِيْئًا مَرِيْئًا
                </p>
                <br />
