          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="pt-4">
                ...
                <p className=" text-[#E98121] font-bold text-lg">দুই.</p>
                <br />
                ...
                <p className="text-xl   leading-relaxed text-justify">
                  ...
                  <p className="text-center pt-3 text-xl">
                    جا کے یہ کہہ دے کوئی شعلوں سے چنگاری سے + پھول اس بار کھلے
                    ہیں بڑی تیاری سے
                  </p>
                  <br />
                  <p className="text-center text-xl ">
                    مدتوں بعد یوں تبدیل ہوا ہے موسم + جیسے چھٹکارا ملا ہو کسی
                    بیماری سے
                  </p>
                  <br />
                  <br />
                ...
                <br />
                <p className=" text-[#E98121] font-bold text-lg">তিন.</p>
                <br />
                ...
                <div className="text-lg leading-relaxed text-justify">
                  ...
                  <br />
                  <p className=" text-[#E98121] pt-3 font-bold text-lg">চার.</p>
                </div>
                <br />
