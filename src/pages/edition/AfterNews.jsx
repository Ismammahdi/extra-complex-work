        ...
        <div className="container mx-auto p-0 md:p-6 mt-5 ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <div className="px-3 py-2 bg-[#D2973B] text-white inline-block">
                খবর ... অতঃপর ...
              </div>
              <p className="mt-6   text-3xl font-bold border-b-2 pb-3 border-gray-300">
                <div>
                  <span className="">খবর ... অতঃপর ...</span>
                </div>
              </p>
              <p className="mt-3 text-xl font-bold text-right">
                (মন্তব্য : আবুন নূর)
              </p>
              <p className="text-xl font-bold py-4 text-[#CA7706]">প্রতীক্ষা</p>
              <p className="mt-6 text-xl text-[#E36C0A]">
                অনেকদিন বন্ধ ছিল ‘খবর... অতঃপর...’ বিভাগ। অনেক পাঠক ফোনে বারবার
                তাগাদা দিয়েছেন এবং প্রতীক্ষায় আছেন।
              </p>
              <br />
              <p className="text-xl ">
              ...
              <br />
              <p className="text-xl ">
                তোমাদের আরো কাছে পেতে চাই বলে চলে গিয়েছিলাম দূরে।
              </p>
              <br />
              <br />
              <br />
              <p className="text-xl font-bold py-4 text-[#CA7706]">জাতীয়</p>

              <p className=" text-xl text-[#E36C0A]">
                ভারতে গণতন্ত্র পরিপক্ব, বাংলাদেশে নয় : সিইসি
              </p>
              <br />
              <p className="text-xl ">নয়া দিগন্ত অনলাইন, ১০ জুন ২০২৪</p>
              <p className="pt-4">
                ...
                <br />
                <p className="text-xl  ">প্রথম আলো, ১১ আগস্ট ২০২৪</p>
                <br />
                <p className="text-xl   leading-relaxed text-justify">
                ...
                <div className="text-lg leading-relaxed text-justify">
                  ...
                  <br />
                  <p className=" text-[#E98121] pt-3 font-bold text-lg">
