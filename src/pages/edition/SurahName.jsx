          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <Link to={"/anwarul-quran"}>
                <p className="px-3 py-2 text-white bg-yellow-600 inline-block">
                  আনওয়ারুল কুরআন
                </p>
              </Link>
              ...
              <p className="mt-6   text-3xl font-bold border-b-2 pb-3 border-gray-300">
                <div>
                  <span className="">সূরাসমূহের নামের অর্থ</span>
                </div>
              ...
              <p className="pt-4">
                <p className="text-xl font-bold pb-4">(পূর্ব প্রকাশের পর)</p>

                <p className=" text-2xl   leading-relaxed text-justify">
                  <span className="mb-3 text-[#E98121] font-bold text-lg">
                    ২৪। সূরা নূর :
                  </span>
