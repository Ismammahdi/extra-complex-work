          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="mt-6   text-3xl font-bold border-b-2 pb-3 border-gray-300">
                <div>
                  <span className="">শরীয়তের দৃষ্টিতে</span>
                </div>

                <span> ট্রান্সজেন্ডার ও ট্রান্সজেন্ডার মতবাদ</span>
                <div></div>
                <span>একটি প্রামাণ্য ফতোয়া</span>
                <div>
                  {" "}
              ...
              <p className="pt-4">
                <p className=" text-xl   leading-relaxed text-justify">
                  ...
                  <br /> <br />
                  <p>
                    ১. মাওলানা মুহাম্মাদ আবদুল মালেক, (আহ্বায়ক), মারকাযুদ দাওয়াহ
                    আলইসলামিয়া ঢাকা <br />
                    <br />
                    ২. মাওলানা মাহফুজুল হক, সদস্য, আল-হাইআতুল উলয়া লিল-জামি‘আতিল
                    কওমিয়া বাংলাদেশ
                    <br />
                    <br />
                    ৩. মাওলানা মুফতি মীযানুর রহমান সাঈদ, শায়খ যাকারিয়া রিসার্চ
                    সেন্টার কুড়িল, ঢাকা
                    <br />
                    <br />
                    ৪. মাওলানা মুফতি আবদুস সালাম, জামিয়া আরাবিয়া ইমদাদুল উলুম
                    ফরিদাবাদ
                    <br />
                    <br />
                    ৫. মাওলানা মুফতি মুহাম্মাদ কেফায়াতুল্লাহ, আল-জামিয়াতুল
                    আহলিয়া দারুল উলূম মুঈনুল ইসলাম হাটহাজারী।
                    <br />
                    <br />
                  </p>
                ...
                <p className="text-xl   leading-relaxed text-justify">
                  ...
                  হারিয়ে যায়। <br /> <br />
                  <p className="">মঙ্গলবার,</p>
                  <br />
                  <p>১২ যিলকদ ১৪৪৫ হিজরী</p>
                  <br />
                  <br />
                  <p className="text-right">
                    ...
                    <br />
                    <br />
                    জাতীয় মুফতি বোর্ড চেয়ারম্যান,
                    <br />
                    <br />
                    চেয়ারম্যান, আল-হাইআতুল উলয়া লিল-জামি‘
                  </p>
                  <br />
                  <br />
                ...
                <div className="text-lg leading-relaxed text-justify">
                  ...
                  <br /> <br />
                  <p>
                    <span className="font-bold">ক.</span> ট্রান্সজেন্ডারবাদ
                    সম্পর্কে ইসলামের দৃষ্টিভঙ্গি কী?
                    <br /> <br />
                    <span className="font-bold">খ.</span> ইসলামী শরীয়তের
                    দৃষ্টিতে হিজড়া আর ট্রান্সজেন্ডার কি এক, না ভিন্ন?
                    <br /> <br />
                    <span className="font-bold">গ.</span>
                    হরমোন থেরাপি বা সার্জারির মাধ্যমে লিঙ্গ পরিচয় পরিবর্তনের
                    অনুমতি আছে কি? পরিবর্তন না করেও নিজেকে নিজে বিপরীত লিঙ্গের
                    মনে করা এবং তা ঘোষণা দেয়ার ব্যাপারে শরীয়তের বিধান কী?
                    <br /> <br />
                    <span className="font-bold">ঘ.</span>
                    মুসলিম দেশে এ ধরনের আইন প্রণয়ন করা শরীয়তের দৃষ্টিতে কেমন এবং
                    এ বিষয়ে আমাদের করণীয় কী?
                    <br /> <br />
                    <span className="font-bold">ঙ.</span>
                    হিজড়াদের ব্যাপারে শরীয়তের বিধান কী? মীরাস (উত্তরাধিকার
                    সম্পত্তি বণ্টন), বিবাহ, পর্দা ইত্যাদি বিধানগুলোতে তাদের
                    ক্ষেত্রে কী পন্থা অবলম্বন করা হবে? তাদের ক্ষেত্রে শরীয়তের
                    বিধান কীভাবে প্রযোজ্য হবে?
                    <br /> <br />
                    <span className="font-bold">চ.</span>
                    শরীয়তের দৃষ্টিতে হিজড়াদের জন্য হরমোন থেরাপি ও সার্জারির
                    অনুমতি আছে কি?
                    <br /> <br />
                    অতএব মুফতি বোর্ড সমীপে আবেদন, আমার উপরোক্ত প্রশ্নগুলোর শরয়ী
                    সমাধান দিয়ে বাধিত করবেন।
                    <br /> <br />
                  </p>
                ...
                <div className="text-lg leading-relaxed text-justify">
                  ...
                  <br />
                  <p>
                    1. Oxford English Dictionary (OED), entry : transgender
                    https://www.oed.com/dictionary/transgender_adj?tl
                    =true&tab=compounds_and_derived_words#12164429 <br />
                    <br />
                    2. Cambridge Dictionary, entry : trans & transgender <br />
                    <br />
