          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="mt-6   text-3xl font-bold border-b-2 pb-3 border-gray-300">
                <span className="">আলজাজিরার প্রতিবেদন</span>
                <br />
                <span className="">
                  সংগ্রামী বীর মুজাহিদ ইয়াহইয়া সিনওয়ার রাহ.
                </span>
                <br />
                <span> শেষ রক্তবিন্দু পর্যন্ত লড়ে গেছেন যিনি</span>
              </p>
              <p className="pt-4">
                ...
                <div className="text-lg leading-relaxed text-justify">
                  <span className="mb-4 text-[#E98121] font-bold text-lg">
                    মোবাইলে ছবি-ভিডিও ধারণ প্রসঙ্গ
                  </span>
                  <span> </span>
                  <span className="text-blue-500 text-xl">
                    কুরআন তিলাওয়াত শোনার সময় একটি কথা কয়েকবার শুনেছি। সেটা হল,
                    হাফসের সূত্রে আসেমের কেরাত। এ কথাটির ব্যাখ্যা কী?
                  </span>
                  <br />
                  <br /> ইতিমধ্যে ইসরাইল তার তথাকথিত বাহাদুরি দেখিয়েছে হামাস
                  প্রধান বীর মুজাহিদ ইয়াহইয়া সিনওয়ারকে হত্যার মাধ্যমে। আমেরিকার
                  বয়োবৃদ্ধ প্রেসিডেন্ট জো বাইডেন খুব খুশি প্রকাশ করেছেন যে,
                  ইয়াহইয়া সিনওয়ারকে হত্যার মাধ্যমে ওই অঞ্চলে শান্তি আসবে। এমন
                  কথা ইসরাইলও বলেছে। এবারই প্রথম না, এর আগেও ইসরাইল যখন বড় কোনো
                ...
                <div className="text-lg leading-relaxed text-justify">
                  ...
                  <span> </span>
                  <span className="text-blue-500 text-xl">
                    উপমহাদেশের কিছু মুসহাফের ভূমিকা, পাদটিকা, ও পরিশিষ্টে
                    তাফসীরে ‘বাহরুল উলূম’-এর হাওয়ালা পাওয়া যায়। যেমন নকল নিজামী
                    মুসহাফ, যা ১৩১২ হি./১৮৯৪ ঈ. সনে লখনৌ-এর নওল কিশোর প্রেস থেকে
                    ছেপেছে। এটি মূলত কানপুরের নিজামী ছাপাখানা থেকে ছাপা নিজামী
                    মুসহাফের প্রতিলিপি। নকল নিজামী মুসহাফের প্রায় প্রত্যেক
                    পৃষ্ঠার টীকায় বাহরুল উলূমের হাওয়ালা রয়েছে। তেমনি আঞ্জুমানে
                    হেমায়াতুল ইসলাম লাহোর-এর সুপ্রসিদ্ধ মুসহাফ (ছাপার সন ১৩৫৪
                    হি.)-এর ভূমিকায় (পৃ. ৪ ও ৪৯-৫০) বলা হয়েছে, উক্ত মুসহাফে
                    ওয়াকফ-ইবতিদার চিহ্ন ‘তাফসীরে বাহরুল উলূম’-এর অবলম্বনে বসানো
                    হয়েছে। মুহতারামের নিকট আমার জানার বিষয় হল, এ তাফসীরের পরিচয়
                    কী? এর লেখক কে? হাওয়ালাগুলো দেখে মনে হচ্ছে কিতাবটি ফারসি
                    ভাষায়।
                  </span>
                  <br />
                  <br />
