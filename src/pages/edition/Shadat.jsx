        ...
        <div className="container mx-auto p-0 md:p-6 mt-5 ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="pt-4">
                <p className="text-xl font-bold py-4 text-[#E36C0A]">
                  ১৫ বছরে আওয়ামী সরকার ঋণ করেছে সাড়ে ১৫ লাখ কোটি টাকার বেশি
                </p>
                <p className="text-xl font-bold py-4 text-[#E36C0A]">
                  এ সময়ে দেশ থেকে পাচার হয়েছে প্রায় ১৫০ বিলিয়ন ডলার
                </p>
