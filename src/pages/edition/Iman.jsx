        ...
        <div className="container mx-auto p-0 md:p-6 mt-5 ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="pt-4">
                <p className="font-bold text-xl mb-5 leading-relaxed ">
                  প্রশ্ন :
                </p>
                <br />
                <p className="text-center text-xl">بسم الله الرحمن الرحيم</p>
                <br />
                ...
                <div className="text-lg leading-relaxed text-justify">
                  <p>
                    ...
                    <p className="text-xl">
                      ...
                      <br /> <br />
                      ২. কুরআনের আরবী পাঠ জরুরি নয় মনে করা।
                      <br /> <br />
                      ৩. কুরবানীর বিধান নিয়ে উপহাস।
                      <br /> <br />
                      ৪. দাড়ি-টুপি নিয়ে উপহাস।
                      <br /> <br />
                      ৫. مِفْتَاحُ الْجَنَّةِ الصَّلَاةُ হাদীসকে কুরআন বিরোধী
                      আখ্যা দেওয়া।
                      <br /> <br />
                      ...
                      <br /> <br />
                      ৮. হ্যানি এটচানের মতো স্পষ্ট কুরআন বিকৃতিকারী ও হাদীস
                      অস্বীকারকারীর অনুসরণ।
                      <br /> <br />
                      ৯. সিলভা মেথড, কসমিক হিলারস ও কোয়ান্টাম মেথডের অনুসরণ এবং
                      সেগুলোর প্রচার-প্রসারে সক্রিয় ভূমিকা পালন।
                      <br /> <br />
                    </p>
                    <br />
