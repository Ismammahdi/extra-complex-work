          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 px-4 relative">
              ...
              <p className="mt-6   text-3xl font-bold border-b-2 pb-3 border-gray-300">
                <div>
                  <span className="">
                    হযরত মাওলানা আবদুল হাই পাহাড়পুরী হুজুর রাহ. ॥
                  </span>
                </div>

                <span> সংক্ষিপ্ত জীবনালেখ্য</span>
                <div>
                  {" "}
              ...
              <p className="text-xl font-bold mt-4">(পূর্ব প্রকাশিতের পর)</p>
              <p className="pt-4">
                ...
                <p className=" text-[#E98121] font-bold text-lg">
                ...
                <br />
                <p className=" text-[#E98121] font-bold text-xl">
                  তাঁর কয়েকজন শাগরিদ
                </p>
                <br />
                <p className="text-xl ">
                  তাঁর অসংখ্য শাগরিদদের মাঝে একান্ত প্রিয় ও ঘনিষ্ঠ হলেন হযরত
                  মাওলানা আবু তাহের মিসবাহ ছাহেব (আদীব হুজুর) দামাত বারাকাতুহুম।
                </p>
                <br />
                <p className="text-xl ">তাঁর শাগরিদদের মাঝে আরো আছেন-</p>
                <br />
                <div className="text-xg leading-relaxed text-justify">
                  <p className="text-xl">
                    * হযরত মাওলানা হিফযুর রহমান ছাহেব (মুমিনপুরী হুজুর) দামাত
                    বারাকাতুহুম।
                  </p>
                  <br />
                  <p className="text-xl">
                    * হযরত মাওলানা আবদুর রাযযাক ছাহেব (মানিকগঞ্জী হুজুর) দামাত
                    বারাকাতুহুম।
                  </p>
                  <br />
                  <p className="text-xl">
                    * তাঁর শায়খ ও মুরশিদের ছাহেবযাদা হযরত মাওলানা আতাউল্লাহ
                    হাফেজ্জী হুজুর দামাত বারাকাতুহুম।
                  </p>
                  <br />
                  <p className="text-xl">
                    * হযরত মাওলানা খালেদ সাইফুল্লাহ ছাহেব দামাত বারাকাতুহুম
                    [হাফেজ্জী হুজুর রাহ.-এর জামাতা]।
                  </p>
                  <br />
                  <p className="text-xl">
                    * হযরত মাওলানা আবদুল হালীম ছাহেব দামাত বারাকাতুহুম [দারুর
                    রাশাদ, মিরপুর]।
                  </p>
                  <br />
                  <p className="text-xl">
                    * হযরত মাওলানা কারী আবুল হুসাইন ছাহেব দামাত বারাকাতুহুম
                    [রেডিও বাংলাদেশ]।
                  </p>
                  <br />
                  <p className="text-xl">
                    * মাওলানা মুহিব্বুল্লাহ ছাহেব দামাত বারাকাতুহুম [লালবাগ
                    জামিয়া]।
                  </p>
                  <br />
                  <p className="text-xl">
                    * মুফতী মুজিবুর রহমান ছাহেব দামাত বারাকাতুহুম [জামিয়া
                    নূরিয়া]।
                  </p>
                  <br />
                  <p className="text-xl">
                    * হযরত মাওলানা যুবায়ের আহমাদ ছাহেব দামাত বারাকাতুহুম
                    [বেফাকুল মাদারিসিল আরাবিয়া বাংলাদেশ]।
                  </p>
                  <br />
                  <p className="text-xl">
                    * হযরত মাওলানা আবদুল হাই ছাহেব দামাত বারাকাতুহুম [উত্তরা]
                    প্রমুখ।
                  </p>
                  <br />
                </div>
                ...
                <div className="text-lg leading-relaxed text-justify">
                  <p className=" text-[#E98121] pt-3 font-bold text-xl">
                    পরিবার ও সন্তানাদি
                  </p>
                </div>
                <br />
